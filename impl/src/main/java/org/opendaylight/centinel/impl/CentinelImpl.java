...
public class CentinelImpl implements AlertruleService, AutoCloseable,
		DataChangeListener {
	int a = 10;

	private static final Logger LOG = LoggerFactory
			.getLogger(CentinelImpl.class);
	...
	private StreamAlertMessageCountRuleList buildAlertMessageCountRuleRecord(
			final SetAlertMessageCountRuleInput input) {

		return new StreamAlertMessageCountRuleListBuilder()
				.setAlertTypeClassifier(input.getAlertTypeClassifier())
				.setMessageCountBacklog(input.getMessageCountBacklog())
				.setMessageCountCount(input.getMessageCountCount())
				.setMessageCountGrace(input.getMessageCountGrace())
				.setMessageCountOperator(input.getMessageCountOperator())
				...
				.setRuleTypeClassifier(input.getRuleTypeClassifier())
				.setStreamID(input.getStreamID()).build();

	}

	private StreamAlertFieldValueRuleList buildAlertFieldValueRuleRecord(
			final SetAlertFieldValueRuleInput input) {

		return new StreamAlertFieldValueRuleListBuilder()
				.setAlertTypeClassifier(input.getAlertTypeClassifier())
				.setFieldValueBacklog(input.getFieldValueBacklog())
				.setFieldValueField(input.getFieldValueField())
				...
				.setFieldValueThreshholdType(
						input.getFieldValueThreshholdType())
				.setFieldValueType(input.getFieldValueType())
				.setTimeStamp(input.getTimeStamp())
				.setNodeType(input.getNodeType())
				.setRuleID(input.getRuleID())
				.setConfigID(String.format("%x", (int) (Math.random() * 10000)))
	...
	private StreamAlertFieldContentRuleList buildAlertFieldContentRuleRecord(
			final SetAlertFieldContentRuleInput input) {

		return new StreamAlertFieldContentRuleListBuilder()
				.setAlertTypeClassifier(input.getAlertTypeClassifier())
				.setFieldContentBacklog(input.getFieldContentBacklog())
				.setFieldContentCompareToValue(
						input.getFieldContentCompareToValue())
				.setFieldContentField(input.getFieldContentField())
				.setFieldContentGrace(input.getFieldContentGrace())
				.setTimeStamp(input.getTimeStamp())
				.setNodeType(input.getNodeType())
				.setRuleID(input.getRuleID())
				.setConfigID(String.format("%x", (int) (Math.random() * 10000)))
    ...
    private StreamAlertMessageCountRuleList buildUpdateAlertMessageCountRuleRecord( 
			...
			StreamAlertMessageCountRuleListBuilder streamAlertMessageCountRuleListBuilder = 
					new StreamAlertMessageCountRuleListBuilder(); 
			...
			else 			streamAlertMessageCountRuleListBuilder.setAlertTypeClassifier(obj.getAlertTypeClassifier()); 
			...
			else streamAlertMessageCountRuleListBuilder.setMessageCountBacklog(obj.getMessageCountBacklog()); 
			 
			if(input.getMessageCountCount() != null) 
				streamAlertMessageCountRuleListBuilder.setMessageCountCount(input.getMessageCountCount()); 
			else			streamAlertMessageCountRuleListBuilder.setMessageCountCount(obj.getMessageCountCount()); 

			 
			if(input.getMessageCountGrace() != null) 
				streamAlertMessageCountRuleListBuilder.setMessageCountCount(input.getMessageCountGrace()); 
			else 			streamAlertMessageCountRuleListBuilder.setMessageCountCount(obj.getMessageCountGrace()); 
			...
			else 			streamAlertMessageCountRuleListBuilder.setMessageCountOperator(obj.getMessageCountOperator()); 

			 
			if(input.getNodeType() != null) 
				streamAlertMessageCountRuleListBuilder.setNodeType(input.getNodeType()); 
			else 			streamAlertMessageCountRuleListBuilder.setNodeType(obj.getNodeType()); 

			 
			if(input.getRuleID() != null) 
				streamAlertMessageCountRuleListBuilder.setRuleID(input.getRuleID()); 
			else 			streamAlertMessageCountRuleListBuilder.setRuleID(obj.getRuleID()); 
			...
			else 			streamAlertMessageCountRuleListBuilder.setRuleTypeClassifier(obj.getRuleTypeClassifier()); 

			 
					 
			if(input.getTimeStamp() != null) 
				streamAlertMessageCountRuleListBuilder.setTimeStamp(input.getTimeStamp()); 
			else 	streamAlertMessageCountRuleListBuilder.setTimeStamp(obj.getTimeStamp()); 
	...
	private StreamAlertFieldContentRuleList buildUpdateAlertFieldContentRuleRecord( 
			...
			StreamAlertFieldContentRuleListBuilder streamAlertFieldContentRuleListBuilder = 
					new StreamAlertFieldContentRuleListBuilder(); 
			 
			if(input.getAlertTypeClassifier() != null) 
				streamAlertFieldContentRuleListBuilder.setAlertTypeClassifier(input.getAlertTypeClassifier()); 
			else 			streamAlertFieldContentRuleListBuilder.setAlertTypeClassifier(obj.getAlertTypeClassifier()); 
			 
			 
			if(input.getFieldContentField() != null) 
				streamAlertFieldContentRuleListBuilder.setFieldContentField(input.getFieldContentField()); 
			else streamAlertFieldContentRuleListBuilder.setFieldContentField(obj.getFieldContentField()); 
			...
			else			streamAlertFieldContentRuleListBuilder.setFieldContentBacklog(obj.getFieldContentBacklog()); 
			...
			else 			streamAlertFieldContentRuleListBuilder.setFieldContentCompareToValue(obj.getFieldContentCompareToValue()); 

			 
			if(input.getFieldContentGrace() != null) 
				streamAlertFieldContentRuleListBuilder.setFieldContentGrace(input.getFieldContentGrace()); 
			else 			streamAlertFieldContentRuleListBuilder.setFieldContentGrace(obj.getFieldContentGrace()); 

			 
			if(input.getNodeType() != null) 
				streamAlertFieldContentRuleListBuilder.setNodeType(input.getNodeType()); 
			else 			streamAlertFieldContentRuleListBuilder.setNodeType(obj.getNodeType()); 
			 

			 
			if(input.getRuleID() != null) 
				streamAlertFieldContentRuleListBuilder.setRuleID(input.getRuleID()); 
			else 			streamAlertFieldContentRuleListBuilder.setRuleID(obj.getRuleID()); 

			 
			if(input.getRuleTypeClassifier() != null) 
				streamAlertFieldContentRuleListBuilder.setRuleTypeClassifier(input.getRuleTypeClassifier()); 
			else 			streamAlertFieldContentRuleListBuilder.setRuleTypeClassifier(obj.getRuleTypeClassifier()); 

			 
					 
			if(input.getTimeStamp() != null) 
				streamAlertFieldContentRuleListBuilder.setTimeStamp(input.getTimeStamp()); 
			else 			streamAlertFieldContentRuleListBuilder.setTimeStamp(obj.getTimeStamp()); 
		...
		private StreamAlertFieldValueRuleList buildUpdateAlertFieldValueRuleRecord( 
			...
			StreamAlertFieldValueRuleListBuilder streamAlertFieldValueRuleListBuilder = 
					new StreamAlertFieldValueRuleListBuilder(); 

			 
			if(input.getAlertTypeClassifier() != null) 
				streamAlertFieldValueRuleListBuilder.setAlertTypeClassifier(input.getAlertTypeClassifier()); 
			else 			streamAlertFieldValueRuleListBuilder.setAlertTypeClassifier(obj.getAlertTypeClassifier()); 


			if(input.getFieldValueBacklog() != null) 
				streamAlertFieldValueRuleListBuilder.setFieldValueBacklog(input.getFieldValueBacklog()); 
			else streamAlertFieldValueRuleListBuilder.setFieldValueBacklog(obj.getFieldValueBacklog()); 
			 
			if(input.getFieldValueField() != null) 
				streamAlertFieldValueRuleListBuilder.setFieldValueField(input.getFieldValueField()); 
			else			streamAlertFieldValueRuleListBuilder.setFieldValueField(obj.getFieldValueField()); 

			 
			if(input.getFieldValueGrace() != null) 
				streamAlertFieldValueRuleListBuilder.setFieldValueGrace(input.getFieldValueGrace()); 
			else 			streamAlertFieldValueRuleListBuilder.setFieldValueGrace(obj.getFieldValueGrace()); 
			...
			else 			streamAlertFieldValueRuleListBuilder.setFieldValueThreshhold(obj.getFieldValueThreshhold()); 
			...
			else 			streamAlertFieldValueRuleListBuilder.setFieldValueThreshholdType(obj.getFieldValueThreshholdType()); 

			 
			if(input.getFieldValueType() != null) 
				streamAlertFieldValueRuleListBuilder.setFieldValueType(input.getFieldValueType()); 
			else 			streamAlertFieldValueRuleListBuilder.setFieldValueType(obj.getFieldValueType()); 

			 
			if(input.getNodeType() != null) 
				streamAlertFieldValueRuleListBuilder.setNodeType(input.getNodeType()); 
			else 			streamAlertFieldValueRuleListBuilder.setNodeType(obj.getNodeType()); 

			 
			if(input.getRuleID() != null) 
				streamAlertFieldValueRuleListBuilder.setRuleID(input.getRuleID()); 
			else 			streamAlertFieldValueRuleListBuilder.setRuleID(obj.getRuleID()); 

			 
			if(input.getRuleTypeClassifier() != null) 
				streamAlertFieldValueRuleListBuilder.setRuleTypeClassifier(input.getRuleTypeClassifier()); 
			else 			streamAlertFieldValueRuleListBuilder.setRuleTypeClassifier(obj.getRuleTypeClassifier()); 

			 
					 
			if(input.getTimeStamp() != null) 
				streamAlertFieldValueRuleListBuilder.setTimeStamp(input.getTimeStamp()); 
			else 			streamAlertFieldValueRuleListBuilder.setTimeStamp(obj.getTimeStamp()); 
	...
	public Future<RpcResult<SetAlertMessageCountRuleOutput>> setAlertMessageCountRule(
		...
		final SettableFuture<RpcResult<SetAlertMessageCountRuleOutput>> futureResult = SettableFuture
				.create();
		...
		setAlertMessageCountRuleOutputBuilder.setMessageCountOperator(input
				.getMessageCountOperator());
		setAlertMessageCountRuleOutputBuilder.setMessageCountCount(input
				.getMessageCountCount());
		setAlertMessageCountRuleOutputBuilder.setMessageCountGrace(input
				.getMessageCountGrace());
		setAlertMessageCountRuleOutputBuilder.setMessageCountBacklog(input
		...
		setAlertMessageCountRuleOutputBuilder.setRuleTypeClassifier(input
		...
		setAlertMessageCountRuleOutputBuilder
				.setTimeStamp(input.getTimeStamp());
		setAlertMessageCountRuleOutputBuilder.setAlertTypeClassifier(input
		...
		final ListenableFuture<Void> commitFuture = Futures
				.transform(
						readFuture,
						new AsyncFunction<Optional<AlertMessageCountRuleRecord>, Void>() {
							...
							public ListenableFuture<Void> apply(
								...
								if (alertMessageCountRuleRecord.isPresent()) {
									streamAlertRuleList = alertMessageCountRuleRecord
											.get()
											.getStreamAlertMessageCountRuleList();

								}
								streamAlertRuleList
										.add(buildAlertMessageCountRuleRecord(input));
								tx.put(LogicalDatastoreType.CONFIGURATION,
										alertMessageCountRuleRecordId,
										new AlertMessageCountRuleRecordBuilder()
												.setStreamAlertMessageCountRuleList(
														streamAlertRuleList)
												.build());
								return tx.submit();
		...
		Futures.addCallback(commitFuture, new FutureCallback<Void>() {
			...
			public void onSuccess(final Void result) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertMessageCountRuleOutput> success(
								setAlertMessageCountRuleOutputBuilder.build())
						.build());
			}
			...
			public void onFailure(final Throwable ex) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertMessageCountRuleOutput> failed()
						.withRpcErrors(
	...
	public Future<RpcResult<SetAlertFieldContentRuleOutput>> setAlertFieldContentRule(
			final SetAlertFieldContentRuleInput input) {
		final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction();
		final SettableFuture<RpcResult<SetAlertFieldContentRuleOutput>> futureResult = SettableFuture
				.create();
		...
		setAlertFieldContentRuleOutputBuilder.setAlertTypeClassifier(input
				.getAlertTypeClassifier());
		setAlertFieldContentRuleOutputBuilder.setFieldContentBacklog(input
				.getFieldContentBacklog());
		setAlertFieldContentRuleOutputBuilder
				.setFieldContentCompareToValue(input
						.getFieldContentCompareToValue());
		setAlertFieldContentRuleOutputBuilder.setFieldContentField(input
				.getFieldContentField());
		setAlertFieldContentRuleOutputBuilder.setFieldContentGrace(input
						...
						new AsyncFunction<Optional<AlertFieldContentRuleRecord>, Void>() {
							...
							public ListenableFuture<Void> apply(
								...
								if (alertFieldContentRuleRecord.isPresent()) {
									streamAlertRuleList = alertFieldContentRuleRecord
											.get()
											.getStreamAlertFieldContentRuleList();

								}
								streamAlertRuleList
										.add(buildAlertFieldContentRuleRecord(input));
								tx.put(LogicalDatastoreType.CONFIGURATION,
										alertFeildContentRuleRecordId,
										new AlertFieldContentRuleRecordBuilder()
												.setStreamAlertFieldContentRuleList(
														streamAlertRuleList)
												.build());
								return tx.submit();
		...
		Futures.addCallback(commitFuture, new FutureCallback<Void>() {
			...
			public void onSuccess(final Void result) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertFieldContentRuleOutput> success(
								setAlertFieldContentRuleOutputBuilder.build())
						.build());
			}
			...
			public void onFailure(final Throwable ex) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertFieldContentRuleOutput> failed()
						.withRpcErrors(
								((TransactionCommitFailedException) ex)
										.getErrorList()).build());
	...
	public Future<RpcResult<SetAlertFieldValueRuleOutput>> setAlertFieldValueRule(
		...
		final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction();
		final SettableFuture<RpcResult<SetAlertFieldValueRuleOutput>> futureResult = SettableFuture
				.create();

		final SetAlertFieldValueRuleOutputBuilder setAlertFieldValueRuleOutputBuilder = new SetAlertFieldValueRuleOutputBuilder();
		setAlertFieldValueRuleOutputBuilder.setAlertTypeClassifier(input
				.getAlertTypeClassifier());
		setAlertFieldValueRuleOutputBuilder.setFieldValueBacklog(input
				.getFieldValueBacklog());
		setAlertFieldValueRuleOutputBuilder.setFieldValueField(input
				.getFieldValueField());
		setAlertFieldValueRuleOutputBuilder.setFieldValueGrace(input
				.getFieldValueGrace());
		setAlertFieldValueRuleOutputBuilder.setFieldValueThreshhold(input
				.getFieldValueThreshhold());
		setAlertFieldValueRuleOutputBuilder.setFieldValueThreshholdType(input
				.getFieldValueThreshholdType());
		setAlertFieldValueRuleOutputBuilder.setFieldValueType(input
				.getFieldValueType());
		...
		setAlertFieldValueRuleOutputBuilder.setRuleTypeClassifier(input
				.getRuleTypeClassifier());
				...
				new AsyncFunction<Optional<AlertFieldValueRuleRecord>, Void>() {
					...
					public ListenableFuture<Void> apply(
						...
						if (alertFieldValueRuleRecord.isPresent()) {
							streamAlertRuleList = alertFieldValueRuleRecord
									.get().getStreamAlertFieldValueRuleList();

						}
						streamAlertRuleList
								.add(buildAlertFieldValueRuleRecord(input));
						tx.put(LogicalDatastoreType.CONFIGURATION,
								alertFieldValueRuleRecordId,
								new AlertFieldValueRuleRecordBuilder()
										.setStreamAlertFieldValueRuleList(
		...
		Futures.addCallback(commitFuture, new FutureCallback<Void>() {
			...
			public void onSuccess(final Void result) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertFieldValueRuleOutput> success(
								setAlertFieldValueRuleOutputBuilder.build())
						.build());
			}
			...
			public void onFailure(final Throwable ex) {
				...
				futureResult.set(RpcResultBuilder
						.<SetAlertFieldValueRuleOutput> failed()
						.withRpcErrors(
								((TransactionCommitFailedException) ex)
										.getErrorList()).build());
		...
		public Future<RpcResult<UpdateAlertMessageCountRuleOutput>> updateAlertMessageCountRule( 
			...
			final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
			final SettableFuture<RpcResult<UpdateAlertMessageCountRuleOutput>> futureResult = SettableFuture 
					.create(); 
			...
			updateAlertMessageCountRuleOutputBuilder.setMessageCountOperator(input 
					.getMessageCountOperator()); 
			updateAlertMessageCountRuleOutputBuilder.setMessageCountCount(input 
					.getMessageCountCount()); 
			updateAlertMessageCountRuleOutputBuilder.setMessageCountGrace(input 
					.getMessageCountGrace()); 
			updateAlertMessageCountRuleOutputBuilder.setMessageCountBacklog(input 
					.getMessageCountBacklog()); 
			...
			updateAlertMessageCountRuleOutputBuilder.setRuleTypeClassifier(input 
					.getRuleTypeClassifier()); 
			updateAlertMessageCountRuleOutputBuilder.setStreamID(input.getStreamID()); 
			updateAlertMessageCountRuleOutputBuilder 
					.setTimeStamp(input.getTimeStamp()); 
			updateAlertMessageCountRuleOutputBuilder.setAlertTypeClassifier(input 
					.getAlertTypeClassifier()); 
			...
			try { 
				...
				futureResult.set(RpcResultBuilder 
						.<UpdateAlertMessageCountRuleOutput> failed() 
						.withRpcErrors( 
									...
									if (alertMessageCountRuleRecord.isPresent()) { 
										...
										while (iterator.hasNext()) { 
											...
											{ 
												...
												updatedStreamAlertRuleList.add(buildUpdateAlertMessageCountRuleRecord(input,configObject)); 
			...
			Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
				...
				public void onSuccess(final Void result) { 
					...
					futureResult.set(RpcResultBuilder 
							.<UpdateAlertMessageCountRuleOutput> success( 
									updateAlertMessageCountRuleOutputBuilder.build()) 
							.build()); 
				} 
				@Override 
				public void onFailure(final Throwable ex) { 
		...
		public Future<RpcResult<UpdateAlertFieldContentRuleOutput>> updateAlertFieldContentRule( 
			...
			final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
			final SettableFuture<RpcResult<UpdateAlertFieldContentRuleOutput>> futureResult = SettableFuture 
					.create(); 
			...
			updateAlertFieldContentRuleOutputBuilder.setFieldContentBacklog(input 
					.getFieldContentBacklog()); 
			updateAlertFieldContentRuleOutputBuilder.setFieldContentCompareToValue(input 
					.getFieldContentCompareToValue()); 
			updateAlertFieldContentRuleOutputBuilder.setFieldContentField(input 
					.getFieldContentField()); 
			updateAlertFieldContentRuleOutputBuilder.setFieldContentGrace(input 
					.getFieldContentGrace()); 
			...
			updateAlertFieldContentRuleOutputBuilder.setRuleTypeClassifier(input 
					.getRuleTypeClassifier()); 
			updateAlertFieldContentRuleOutputBuilder.setStreamID(input.getStreamID()); 
			updateAlertFieldContentRuleOutputBuilder 
					.setTimeStamp(input.getTimeStamp()); 
			updateAlertFieldContentRuleOutputBuilder.setAlertTypeClassifier(input 
					.getAlertTypeClassifier()); 
			...
			try { 
				...
				futureResult.set(RpcResultBuilder 
						.<UpdateAlertFieldContentRuleOutput> failed() 
						.withRpcErrors( 
								((TransactionCommitFailedException) e) 
										.getErrorList()).build()); 
				return futureResult; 
								...
								public ListenableFuture<Void> apply( 
									...
									if (alertFieldContentRuleRecord.isPresent()) { 
										...
										while (iterator.hasNext()) { 
											...
											if(configObject.getConfigID().equalsIgnoreCase(configID)) 
											{ 
												updatedStreamAlertRuleList.add(buildUpdateAlertFieldContentRuleRecord(input,configObject)); 
											  tx.merge(LogicalDatastoreType.CONFIGURATION, 
													  alertFeildContentRuleRecordId, 
												new AlertFieldContentRuleRecordBuilder(). 
												setStreamAlertFieldContentRuleList( 
			...
			Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
				...
				public void onSuccess(final Void result) { 
					...
					futureResult.set(RpcResultBuilder 
							.<UpdateAlertFieldContentRuleOutput> success( 
									updateAlertFieldContentRuleOutputBuilder.build()) 
							.build()); 
				} 
				@Override 
				public void onFailure(final Throwable ex) { 
		...
		public Future<RpcResult<UpdateAlertFieldValueRuleOutput>> updateAlertFieldValueRule( 
				...
				final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
				final SettableFuture<RpcResult<UpdateAlertFieldValueRuleOutput>> futureResult = SettableFuture 
						.create(); 
				...
				updateAlertFieldValueRuleOutputBuilder.setRuleTypeClassifier(input 
						.getRuleTypeClassifier()); 
				updateAlertFieldValueRuleOutputBuilder.setStreamID(input.getStreamID()); 
				updateAlertFieldValueRuleOutputBuilder 
						.setTimeStamp(input.getTimeStamp()); 
				updateAlertFieldValueRuleOutputBuilder.setAlertTypeClassifier(input 
						.getAlertTypeClassifier()); 
				...
				try { 
					...
					futureResult.set(RpcResultBuilder 
							.<UpdateAlertFieldValueRuleOutput> failed() 
							.withRpcErrors( 
									((TransactionCommitFailedException) e) 
											.getErrorList()).build()); 
					return futureResult; 
									...
									public ListenableFuture<Void> apply( 
										...
										if (alertFieldValueRuleRecord.isPresent()) { 
											...
											while (iterator.hasNext()) { 
												...
												if(configObject.getConfigID().equalsIgnoreCase(configID)) 
												{ 
													updatedStreamAlertRuleList.add(buildUpdateAlertFieldValueRuleRecord(input,configObject)); 
				...
				Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
					...
					public void onSuccess(final Void result) { 
						...
						futureResult.set(RpcResultBuilder 
								.<UpdateAlertFieldValueRuleOutput> success( 
										updateAlertFieldValueRuleOutputBuilder.build()) 
								.build()); 
					} 
					@Override 
					public void onFailure(final Throwable ex) { 
		...
		public Future<RpcResult<DeleteAlertMessageCountRuleOutput>> deleteAlertMessageCountRule( 
			...
			final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
			final SettableFuture<RpcResult<DeleteAlertMessageCountRuleOutput>> futureResult = SettableFuture 
					.create(); 
			...
			deleteAlertMessageCountRuleOutputBuilder.setMessageCountOperator(input 
					.getMessageCountOperator()); 
			deleteAlertMessageCountRuleOutputBuilder.setMessageCountCount(input 
					.getMessageCountCount()); 
			deleteAlertMessageCountRuleOutputBuilder.setMessageCountGrace(input 
					.getMessageCountGrace()); 
			deleteAlertMessageCountRuleOutputBuilder.setMessageCountBacklog(input 
					.getMessageCountBacklog()); 
			...
			deleteAlertMessageCountRuleOutputBuilder.setRuleTypeClassifier(input 
					.getRuleTypeClassifier()); 
			deleteAlertMessageCountRuleOutputBuilder.setStreamID(input.getStreamID()); 
			deleteAlertMessageCountRuleOutputBuilder 
					.setTimeStamp(input.getTimeStamp()); 
			deleteAlertMessageCountRuleOutputBuilder.setAlertTypeClassifier(input 
					.getAlertTypeClassifier()); 
			...
			try { 
				...
				futureResult.set(RpcResultBuilder 
						.<DeleteAlertMessageCountRuleOutput> failed() 
						.withRpcErrors( 
								((TransactionCommitFailedException) e) 
										.getErrorList()).build()); 
				return futureResult; 
			...
			Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
				...
				public void onSuccess(final Void result) { 
					...
					futureResult.set(RpcResultBuilder 
							.<DeleteAlertMessageCountRuleOutput> success( 
									deleteAlertMessageCountRuleOutputBuilder.build()) 
							.build()); 
				} 
				@Override 
				public void onFailure(final Throwable ex) { 
		...
		public Future<RpcResult<DeleteAlertFieldContentRuleOutput>> deleteAlertFieldContentRule( 
			...
			final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
			final SettableFuture<RpcResult<DeleteAlertFieldContentRuleOutput>> futureResult = SettableFuture 
					.create(); 
			...
			deleteAlertFieldContentRuleOutputBuilder.setFieldContentBacklog(input 
					.getFieldContentBacklog()); 
			deleteAlertFieldContentRuleOutputBuilder.setFieldContentCompareToValue(input 
					.getFieldContentCompareToValue()); 
			deleteAlertFieldContentRuleOutputBuilder.setFieldContentField(input 
					.getFieldContentField()); 
			deleteAlertFieldContentRuleOutputBuilder.setFieldContentGrace(input 
					.getFieldContentGrace()); 
			...
			deleteAlertFieldContentRuleOutputBuilder.setRuleTypeClassifier(input 
					.getRuleTypeClassifier()); 
			deleteAlertFieldContentRuleOutputBuilder.setStreamID(input.getStreamID()); 
			deleteAlertFieldContentRuleOutputBuilder 
					.setTimeStamp(input.getTimeStamp()); 
			deleteAlertFieldContentRuleOutputBuilder.setAlertTypeClassifier(input 
					.getAlertTypeClassifier()); 
			...
			try { 
				...
				futureResult.set(RpcResultBuilder 
						.<DeleteAlertFieldContentRuleOutput> failed() 
						.withRpcErrors( 
								((TransactionCommitFailedException) e) 
										.getErrorList()).build()); 
				return futureResult; 
									...
									if (alertFieldContentRuleRecord.isPresent()) { 
										...
										while (iterator.hasNext()) { 
											...
											{ 
												...
												tx.delete(LogicalDatastoreType.CONFIGURATION,alertFeildContentRuleRecordId.child(StreamAlertFieldContentRuleList.class, configObject.getKey())); 
			...
			Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
				...
				public void onSuccess(final Void result) { 
					...
					futureResult.set(RpcResultBuilder 
							.<DeleteAlertFieldContentRuleOutput> success( 
									deleteAlertFieldContentRuleOutputBuilder.build()) 
							.build()); 
				} 
				@Override 
				public void onFailure(final Throwable ex) { 
		...
		public Future<RpcResult<DeleteAlertFieldValueRuleOutput>> deleteAlertFieldValueRule( 
			...
			final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction(); 
			final SettableFuture<RpcResult<DeleteAlertFieldValueRuleOutput>> futureResult = SettableFuture 
					.create(); 
			...
			deleteAlertFieldValueRuleOutputBuilder.setRuleTypeClassifier(input 
					.getRuleTypeClassifier()); 
			deleteAlertFieldValueRuleOutputBuilder.setStreamID(input.getStreamID()); 
			deleteAlertFieldValueRuleOutputBuilder 
					.setTimeStamp(input.getTimeStamp()); 
			deleteAlertFieldValueRuleOutputBuilder.setAlertTypeClassifier(input 
					.getAlertTypeClassifier()); 
			...
			try { 
				...
				futureResult.set(RpcResultBuilder 
						.<DeleteAlertFieldValueRuleOutput> failed() 
						.withRpcErrors( 
								((TransactionCommitFailedException) e) 
										.getErrorList()).build()); 
				return futureResult; 
									...
									if (alertFieldValueRuleRecord.isPresent()) { 
										...
										while (iterator.hasNext()) { 
											...
											{ 
												...
												tx.delete(LogicalDatastoreType.CONFIGURATION,alertFieldValueRuleRecordId.child(StreamAlertFieldValueRuleList.class, configObject.getKey())); 
			...
			Futures.addCallback(commitFuture, new FutureCallback<Void>() { 
				...
				public void onSuccess(final Void result) { 
					...
					futureResult.set(RpcResultBuilder 
							.<DeleteAlertFieldValueRuleOutput> success( 
									deleteAlertFieldValueRuleOutputBuilder.build()) 
							.build()); 
				} 
				@Override 
				public void onFailure(final Throwable ex) { 
	...
	public void onDataChanged(
		...
		if (dataObject instanceof AlertMessageCountRuleRecord) {
			...
			Iterator<DataObject> iterator = change.getCreatedData().values()
					.iterator();
			if (iterator.hasNext()) {
				...
				LOG.info("Alert message count rule list: "
						...
						.transform(
								...
								new AsyncFunction<Optional<AlertMessageCountRuleRecord>, Void>() {
									...
									public ListenableFuture<Void> apply(
										...
										streamAlertRuleList
												.add(streamAlertMessageCountRuleList);
				...
				Futures.addCallback(commitFuture, new FutureCallback<Void>() {
					...
					public void onFailure(final Throwable ex) {
						...
						LOG.debug(
								"Failed to commit Rule to operational datastore on data change",
								ex);
			...
			if (iterator.hasNext()) {
				...
				LOG.info("Alert Field value rule list: "
						...
						.transform(
								...
								new AsyncFunction<Optional<AlertFieldValueRuleRecord>, Void>() {
									...
									public ListenableFuture<Void> apply(
										...
										streamAlertRuleList
												.add(streamAlertFieldValueRuleList);
										tx.put(LogicalDatastoreType.OPERATIONAL,
												alertFieldValueRuleRecordId,
												new AlertFieldValueRuleRecordBuilder()
														.setStreamAlertFieldValueRuleList(
			...
			if (iterator.hasNext()) {
				...
				LOG.info("Alert Field content rule list: "
						...
						.transform(
								...
								new AsyncFunction<Optional<AlertFieldContentRuleRecord>, Void>() {
									...
									public ListenableFuture<Void> apply(
										...
										if (alertFieldContentRuleRecord
												.isPresent()) {
											streamAlertRuleList = alertFieldContentRuleRecord
													.get()
													.getStreamAlertFieldContentRuleList();
										...
										streamAlertRuleList
												.add(streamAlertFieldContentRuleList);
										tx.put(LogicalDatastoreType.OPERATIONAL,
												alertFeildContentRuleRecordId,
												new AlertFieldContentRuleRecordBuilder()
														.setStreamAlertFieldContentRuleList(
	 ...
	 */
	@Override
	public Future<RpcResult<GetAllAlertRuleOutput>> getAllAlertRule(
			final GetAllAlertRuleInput input) {
	
		final ReadWriteTransaction tx = dataProvider.newReadWriteTransaction();
		final SettableFuture<RpcResult<GetAllAlertRuleOutput>> futureResult = SettableFuture
				.create();
		...
		ListenableFuture<Optional<AlertFieldValueRuleRecord>> alertFieldValueReadFuture = tx
				.read(LogicalDatastoreType.OPERATIONAL,
						alertFieldValueRuleRecordId);
		try {
			Optional<AlertMessageCountRuleRecord> alertMessageCountRuleRecord = alertMessageCountReadFuture
					.get();
			List<StreamAlertMessageCountRuleList> streamAlertRuleList = new ArrayList<StreamAlertMessageCountRuleList>();
			...
			java.util.Iterator<StreamAlertMessageCountRuleList> iterator = streamAlertRuleList
					.iterator();
			...
			while (iterator.hasNext()) {
				StreamAlertMessageCountRuleList streamAlertMessageObj = iterator
						.next();
				if (streamAlertMessageObj.getStreamID().equals(
						input.getStreamID())) {
					...
					streamAlertMessageCountRuleListSortedBuilder
							.setRuleID(streamAlertMessageObj.getRuleID());
					streamAlertMessageCountRuleListSortedBuilder
							.setAlertTypeClassifier(streamAlertMessageObj
									.getAlertTypeClassifier());
					streamAlertMessageCountRuleListSortedBuilder
							.setMessageCountCount(streamAlertMessageObj
									.getMessageCountCount());
					streamAlertMessageCountRuleListSortedBuilder
							.setMessageCountGrace(streamAlertMessageObj
									.getMessageCountGrace());
					streamAlertMessageCountRuleListSortedBuilder
							.setTimeStamp(streamAlertMessageObj.getTimeStamp());
					streamAlertMessageCountRuleListSortedBuilder
							.setMessageCountBacklog(streamAlertMessageObj
									.getMessageCountBacklog());
		...
		try {
			Optional<AlertFieldContentRuleRecord> alertFieldContentRuleRecord = alertFieldContentReadFuture
					.get();
			List<StreamAlertFieldContentRuleList> streamAlertRuleList = new ArrayList<StreamAlertFieldContentRuleList>();
			...
			java.util.Iterator<StreamAlertFieldContentRuleList> iterator = streamAlertRuleList
					.iterator();
			...
			while (iterator.hasNext()) {
				StreamAlertFieldContentRuleList streamAlertFieldContentObj = iterator
						.next();

				if (streamAlertFieldContentObj.getStreamID().equals(
						input.getStreamID())) {
					streamAlertFieldContentRuleListSortedBuilder
							.setConfigID(streamAlertFieldContentObj
									.getConfigID());
					streamAlertFieldContentRuleListSortedBuilder
							.setRuleID(streamAlertFieldContentObj.getRuleID());
					streamAlertFieldContentRuleListSortedBuilder
							.setStreamID(streamAlertFieldContentObj
									.getStreamID());
					streamAlertFieldContentRuleListSortedBuilder
							.setFieldContentBacklog(streamAlertFieldContentObj
									.getFieldContentBacklog());
					streamAlertFieldContentRuleListSortedBuilder
							.setFieldContentCompareToValue(streamAlertFieldContentObj
									.getFieldContentCompareToValue());
					streamAlertFieldContentRuleListSortedBuilder
							.setFieldContentGrace(streamAlertFieldContentObj
									.getFieldContentGrace());
					streamAlertFieldContentRuleListSortedBuilder
							.setFieldContentField(streamAlertFieldContentObj
									.getFieldContentField());
		...
		try {
			Optional<AlertFieldValueRuleRecord> alertFieldValueRuleRecord = alertFieldValueReadFuture
					.get();
			List<StreamAlertFieldValueRuleList> streamAlertRuleList = new ArrayList<StreamAlertFieldValueRuleList>();
			...
			java.util.Iterator<StreamAlertFieldValueRuleList> iterator = streamAlertRuleList
					.iterator();
			...
			while (iterator.hasNext()) {
				StreamAlertFieldValueRuleList streamAlertFieldValueRuleObj = iterator
						.next();
				if (streamAlertFieldValueRuleObj.getStreamID().equals(
						input.getStreamID())) {
					streamAlertFieldValueRuleListSortedBuilder
							.setConfigID(streamAlertFieldValueRuleObj
									.getConfigID());
					streamAlertFieldValueRuleListSortedBuilder
							.setRuleID(streamAlertFieldValueRuleObj.getRuleID());
					streamAlertFieldValueRuleListSortedBuilder
							.setStreamID(streamAlertFieldValueRuleObj
									.getStreamID());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueBacklog(streamAlertFieldValueRuleObj
									.getFieldValueBacklog());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueField(streamAlertFieldValueRuleObj
									.getFieldValueField());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueThreshholdType(streamAlertFieldValueRuleObj
									.getFieldValueThreshholdType());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueThreshhold(streamAlertFieldValueRuleObj
									.getFieldValueThreshhold());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueType(streamAlertFieldValueRuleObj
									.getFieldValueType());
					streamAlertFieldValueRuleListSortedBuilder
							.setFieldValueGrace(streamAlertFieldValueRuleObj
									.getFieldValueGrace());
			...
			futureResult.set(RpcResultBuilder.<GetAllAlertRuleOutput> success(
					allAlertRuleOutputBuilder.build()).build());
