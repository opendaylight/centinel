...
public class CentinelAlertConditionImplFactory {
	...
	/* mock streamRecord */
	public AlertFieldValueRuleRecord getAlertFieldValueRuleRecord() {
		AlertFieldValueRuleRecordBuilder alertFieldValueRuleRecordBuilder = new AlertFieldValueRuleRecordBuilder();
		List<StreamAlertFieldValueRuleList> streamAlertFieldValueRuleList = new ArrayList<StreamAlertFieldValueRuleList>();
		streamAlertFieldValueRuleList.add(getStreamAlertFieldValueRuleList());
		alertFieldValueRuleRecordBuilder
				.setStreamAlertFieldValueRuleList(streamAlertFieldValueRuleList);
		return alertFieldValueRuleRecordBuilder.build();
	}

	/* mock streamRecord */
	public AlertFieldContentRuleRecord getAlertFieldContentRuleRecord() {
		...
		streamAlertFieldContentRuleList
				.add(getStreamAlertFieldContentRuleList());
		alertFieldContentRuleRecordBuilder
				.setStreamAlertFieldContentRuleList(streamAlertFieldContentRuleList);
		return alertFieldContentRuleRecordBuilder.build();
	}

	/* mock streamRecord */
	public AlertMessageCountRuleRecord getAlertMessageCountRuleRecord() {
		AlertMessageCountRuleRecordBuilder alertMessageCountRuleRecordBuilder = new AlertMessageCountRuleRecordBuilder();
		...
		streamAlertMessageCountRuleList
				.add(getStreamAlertMessageCountRuleList());
		alertMessageCountRuleRecordBuilder
				.setStreamAlertMessageCountRuleList(streamAlertMessageCountRuleList);
		return alertMessageCountRuleRecordBuilder.build();
	}

	public static StreamAlertFieldValueRuleList getStreamAlertFieldValueRuleList() {
		...
		streamAlertFieldValueRuleListBuilder.setAlertName("alert");
		streamAlertFieldValueRuleListObj.setStreamID("str001");
		streamAlertFieldValueRuleListObj.setConfigID("1000");
		streamAlertFieldValueRuleListObj.setRuleID("rule1");
		return streamAlertFieldValueRuleListObj.build();
	}

	public static StreamAlertMessageCountRuleList getStreamAlertMessageCountRuleList() {
		...
		streamAlertMessageCountRuleListBuilder.setAlertName("alert");
		streamAlertMessageCountRuleListObj.setStreamID("str001");
		streamAlertMessageCountRuleListObj.setConfigID("1000");
		streamAlertMessageCountRuleListObj.setRuleID("100");
		return streamAlertMessageCountRuleListObj.build();
	}

	public static StreamAlertFieldContentRuleList getStreamAlertFieldContentRuleList() {
		StreamAlertFieldContentRuleListBuilder streamAlertFieldContentRuleListBuilderObj = new StreamAlertFieldContentRuleListBuilder();
		StreamAlertFieldContentRuleListBuilder streamAlertFieldContentRuleListBuilder = new StreamAlertFieldContentRuleListBuilder();
		streamAlertFieldContentRuleListBuilder.setAlertName("alert");
		streamAlertFieldContentRuleListBuilderObj.setStreamID("str001");
		streamAlertFieldContentRuleListBuilderObj.setConfigID("1000");
		return streamAlertFieldContentRuleListBuilderObj.build();
	}
	...
	public SetAlertMessageCountRuleOutput expectedAlertMessageCountRuleObject() {
		...
		setAlertMessageCountRuleOutputBuilder
				.setAlertTypeClassifier(AlertType.AlertMessageCount);
		setAlertMessageCountRuleOutputBuilder
				.setMessageCountBacklog((short) 18);
		...
		setAlertMessageCountRuleOutputBuilder
				.setRuleTypeClassifier(RuleType.BaseAlert);
	...
	public SetAlertMessageCountRuleInput setInputBuilderWithMissingInput() {
		...
		setAlertMessageCountRuleInputBuilder
				.setRuleTypeClassifier(RuleType.BaseAlert);
	...
	public SetAlertFieldValueRuleOutput expectedAlertFieldValueRuleObject() {
		...
		setAlertFieldValueRuleOutputBuilder
				.setAlertTypeClassifier(AlertType.AlertFieldValue);
	...
	public SetAlertFieldValueRuleInput setInputForAlertFieldValueRule() {
		...
		alertFieldValueRuleInputBuilder
				.setAlertTypeClassifier(AlertType.AlertFieldValue);
	...
	public SetAlertFieldContentRuleOutput expectedAlertFieldContentRuleObject() {
		...
		setAlertFieldContentRuleOutputBuilder
				.setFieldContentCompareToValue("one");
		...
		setAlertFieldContentRuleOutputBuilder
				.setAlertTypeClassifier(AlertType.AlertFieldContent);
		setAlertFieldContentRuleOutputBuilder.setFieldContentField("new");
		setAlertFieldContentRuleOutputBuilder
				.setFieldContentBacklog((short) 45);
	...
	public SetAlertFieldContentRuleInput setInputForAlertFieldContentRule() {
		...
		setAlertFieldContentRuleInputBuilder
				.setFieldContentCompareToValue("one");
	...
	public SetAlertFieldContentRuleInput setInputForAlertFieldContentWithInvalidInput() {
		...
		setAlertFieldContentRuleInputBuilder
				.setFieldContentCompareToValue(null);
	...
	public UpdateAlertMessageCountRuleOutput expectedUpdatedAlertMessageCountRuleObject() {
		...
		updateAlertMessageCountRuleOutputBuilder
				.setMessageCountBacklog((short) 18);
		updateAlertMessageCountRuleOutputBuilder
				.setMessageCountCount((short) 15);
		updateAlertMessageCountRuleOutputBuilder
				.setMessageCountGrace((short) 45);
		updateAlertMessageCountRuleOutputBuilder
				.setRuleTypeClassifier(RuleType.BaseAlert);
	...
	public UpdateAlertMessageCountRuleInput updateValidInputForAlertMessageCount() {
		UpdateAlertMessageCountRuleInputBuilder updateAlertMessageCountRuleInputBuilder = new UpdateAlertMessageCountRuleInputBuilder();
		updateAlertMessageCountRuleInputBuilder.setStreamID("str001");
		updateAlertMessageCountRuleInputBuilder.setRuleID("100");
		updateAlertMessageCountRuleInputBuilder.setConfigID("1000");
		return updateAlertMessageCountRuleInputBuilder.build();
	}

	public UpdateAlertFieldValueRuleInput updateInputForAlertFieldValueRule() {
		UpdateAlertFieldValueRuleInputBuilder updateAlertMessageCountRuleInputBuilder = new UpdateAlertFieldValueRuleInputBuilder();
		return updateAlertMessageCountRuleInputBuilder.build();
	}

	public UpdateAlertFieldContentRuleInput updateInputForAlertFieldContentRule() {
	...
	public UpdateAlertMessageCountRuleInput updateInputForAlertMessageCountWithInvalidValues() {
		UpdateAlertMessageCountRuleInputBuilder updateAlertMessageCountRuleInputBuilder = new UpdateAlertMessageCountRuleInputBuilder();
		updateAlertMessageCountRuleInputBuilder.setConfigID("1000");
		updateAlertMessageCountRuleInputBuilder
				.setMessageCountOperator("hello");
	...
	public UpdateAlertFieldContentRuleInput updateInputWithValidValuesForAlertFieldContentRule() {
		...
		updateAlertFieldContentRuleInputBuilder
				.setAlertTypeClassifier(AlertType.AlertMessageCount);
		updateAlertFieldContentRuleInputBuilder
				.setRuleTypeClassifier(RuleType.BaseAlert);
	...
	public UpdateAlertFieldValueRuleInput updateInputWithValidValuesForAlertFieldValueRule() {
		...
		updateAlertFieldValueInputBuilder
				.setAlertTypeClassifier(AlertType.AlertMessageCount);
		updateAlertFieldValueInputBuilder
				.setRuleTypeClassifier(RuleType.BaseAlert);
	...
	public GetAllAlertRuleInput getAllRulesInputWithValidValues() {
		GetAllAlertRuleInputBuilder getallAlertRuleInputBuilder = new GetAllAlertRuleInputBuilder();
		getallAlertRuleInputBuilder.setStreamID("str001");
		return getallAlertRuleInputBuilder.build();
	}
	...
	public DeleteAlertMessageCountRuleInput deleteInputValidValuesForAlertMessageCounts() {
		DeleteAlertMessageCountRuleInputBuilder deleteAlertMessageCountRuleInputBuilder = new DeleteAlertMessageCountRuleInputBuilder();
		deleteAlertMessageCountRuleInputBuilder.setStreamID("str001");
		deleteAlertMessageCountRuleInputBuilder.setRuleID("100");
		deleteAlertMessageCountRuleInputBuilder.setConfigID("1000");
		return deleteAlertMessageCountRuleInputBuilder.build();
	}
